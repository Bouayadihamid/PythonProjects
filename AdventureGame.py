...
while not (choice1 == 'yes' or choice1 == 'no'):
    choice1 = input('That is an invalid input. Enter yes or no: ')
if choice1 == 'yes':
    ...
    if direction == 'north':
        ...
        if item == 'm':
            print('You use the map and find you way home.')
        ...
        print('This could be a long time. You are still los.')
...
if answer.lower() == 'python':
    ...
    if item == 'c':
        ...
        print('CONGRATULATIONS! You got out sfely. You won the game.')
    else:
